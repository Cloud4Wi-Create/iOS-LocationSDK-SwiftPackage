...
@class GUCircularArea;

/// Object which wrap the visit
SWIFT_CLASS("_TtC7GeoUniq25FrequentlyVisitedLocation")
@interface FrequentlyVisitedLocation : NSObject
@property (nonatomic, strong) GUCircularArea * _Nonnull circularArea;
@property (nonatomic) double timeSpentHours;
@property (nonatomic) NSInteger numberOfVisits;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// Object which wrap the attribute: id, name
SWIFT_CLASS("_TtC7GeoUniq11GUAttribute")
@interface GUAttribute : NSObject
...
/// Delegate to implement in order to receive callbacks when attributes list changed
SWIFT_PROTOCOL("_TtP7GeoUniq19GUAttributeListener_")
@protocol GUAttributeListener
/// Public constructor
- (nonnull instancetype)init;
/// Called when attributes list changed
/// \param attributes array of attributes
///
- (void)onAttributesListChangedWithAttributes:(NSArray<GUAttribute *> * _Nonnull)attributes;
@end
...
SWIFT_PROTOCOL("_TtP7GeoUniq18LocationOfInterest_")
@protocol LocationOfInterest
@property (nonatomic, readonly) NSInteger id;
@property (nonatomic, readonly, strong) GUGeoPoint * _Nonnull referenceLocation;
@end


/// Object which wrap the home location: include an id and a reference location (lat and lng)
SWIFT_CLASS("_TtC7GeoUniq14GUHomeLocation")
@interface GUHomeLocation : NSObject <LocationOfInterest>
@property (nonatomic) NSInteger id;
@property (nonatomic, strong) GUGeoPoint * _Nonnull referenceLocation;
...
SWIFT_PROTOCOL("_TtP7GeoUniq22GUHomeLocationListener_")
@protocol GUHomeLocationListener
/// Public constructor
- (nonnull instancetype)init;
/// Called when a new home location is detected
/// \param GUHomeLocation Home location detected
///
- (void)onNewHomeLocationDetectedWithHome:(GUHomeLocation * _Nonnull)home;
@end
...
typedef SWIFT_ENUM(NSInteger, GUTransitionStatus, open) {
/// INSIDE
///
/// returns:
/// indicates that you are interested in the “inside” transaction
  GUTransitionStatusINSIDE = 0,
/// OUTSIDE
///
/// returns:
/// indicates that you are interested in the “outside” transaction
  GUTransitionStatusOUTSIDE = 1,
};


/// Object which wrap the work location: include an id and a reference location (lat and lng)
SWIFT_CLASS("_TtC7GeoUniq14GUWorkLocation")
@interface GUWorkLocation : NSObject <LocationOfInterest>
@property (nonatomic) NSInteger id;
@property (nonatomic, strong) GUGeoPoint * _Nonnull referenceLocation;
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
...
SWIFT_PROTOCOL("_TtP7GeoUniq22GUWorkLocationListener_")
@protocol GUWorkLocationListener
/// Public constructor
- (nonnull instancetype)init;
/// Called when a new work location is detected
/// \param GUWorkLocation Work location detected
///
- (void)OnNewWorkLocationDetectedWithWork:(GUWorkLocation * _Nonnull)work;
@end
...
- (enum ATTrackingManagerAuthorizationStatus)getATTrackingAuthorizationStatus SWIFT_WARN_UNUSED_RESULT SWIFT_AVAILABILITY(ios,introduced=14.0);
- (void)requestATTrackingAuthorizationWithCompletion:(void (^ _Nonnull)(enum ATTrackingManagerAuthorizationStatus))completion SWIFT_AVAILABILITY(ios,introduced=14);
/// Return the current Home Location if detected, nil otherwise
///
/// returns:
/// the current Home Location
- (GUHomeLocation * _Nullable)getHomeLocation SWIFT_WARN_UNUSED_RESULT;
/// Return the current Work Location if detected, nil otherwise
///
/// returns:
/// the current Work Location
- (GUWorkLocation * _Nullable)getWorkLocation SWIFT_WARN_UNUSED_RESULT;
/// Register a delegate to receive all the home location update, even in background
/// \param listener listener to register
///
- (void)setHomeLocationListenerWithListener:(Class <GUHomeLocationListener> _Nonnull)listener;
/// Remove a registered delegate for home location update
/// \param listener registered listener
///
///
/// returns:
/// true if a argument listener exists. False otherwise.
- (BOOL)removeHomeLocationListenerWithListener:(Class <GUHomeLocationListener> _Nonnull)listener SWIFT_WARN_UNUSED_RESULT;
/// Allows to obtain the set listeners
///
/// returns:
/// <code>[GUHomeLocationListener.Type]</code>
- (NSArray<Class <GUHomeLocationListener>> * _Nullable)getHomeLocationListeners SWIFT_WARN_UNUSED_RESULT;
/// Removes all listener previously set
- (void)removeHomeLocationListeners;
/// Register a delegate to receive all the work location update, even in background
/// \param listener listener to register
///
- (void)setWorkLocationListenerWithListener:(Class <GUWorkLocationListener> _Nonnull)listener;
/// Remove a registered delegate for work location update
/// \param listener registered listener
///
///
/// returns:
/// true if a argument listener exists. False otherwise.
- (BOOL)removeWorkLocationListenerWithListener:(Class <GUWorkLocationListener> _Nonnull)listener SWIFT_WARN_UNUSED_RESULT;
/// Allows to obtain the set listeners
///
/// returns:
/// <code>[GUWorkLocationListener.Type]</code>
- (NSArray<Class <GUWorkLocationListener>> * _Nullable)getWorkLocationListeners SWIFT_WARN_UNUSED_RESULT;
/// Removes all listener previously set
- (void)removeWorkLocationListeners;
- (void)setStatusWriteLogs:(BOOL)status;
- (BOOL)getStatusWriteLogs SWIFT_WARN_UNUSED_RESULT;
@end
...
SWIFT_CLASS("_TtC7GeoUniq43PersistenceOptionalAttributesDefinitionList")
@interface PersistenceOptionalAttributesDefinitionList : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC7GeoUniq33PersistenceOptionalAttributesList")
@interface PersistenceOptionalAttributesList : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC7GeoUniq42PersistenceOptionalBehavioralBasedTagArray")
@interface PersistenceOptionalBehavioralBasedTagArray : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC7GeoUniq32PersistenceOptionalCensusSection")
@interface PersistenceOptionalCensusSection : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC7GeoUniq23PersistenceOptionalDate")
@interface PersistenceOptionalDate : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC7GeoUniq35PersistenceOptionalHomeBaseTagArray")
@interface PersistenceOptionalHomeBaseTagArray : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC7GeoUniq27PersistenceOptionalTagArray")
@interface PersistenceOptionalTagArray : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC7GeoUniq32PersistenceOptionalTagVisitsList")
@interface PersistenceOptionalTagVisitsList : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC7GeoUniq37PersistenceOptionalVisitBasedTagArray")
@interface PersistenceOptionalVisitBasedTagArray : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
